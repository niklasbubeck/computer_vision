...
class PointConvSceneFlowPWC8192selfglobalPointConv(nn.Module):
    def __init__(self):
        ...
        self.level2 = PointConvD(1536, feat_nei, 32 + 3, 32)
        #self.cost2 = PointConvFlow(flow_nei, 128 + 64 + 128 + 64 + 3, [128, 128])
        self.cost2 = PointConvFlow(flow_nei, 131, [32, 32])
        #self.flow2 = SceneFlowEstimatorPointConv(128 + 64, 64)
        self.flow2 = SceneFlowEstimatorPointConv(32 + 64, 32)
        self.level2_0 = Conv1d(32, 32)
        self.level2_1 = Conv1d(32, 64)

        #l3: 256
        self.level3 = PointConvD(256, feat_nei, 64 + 3, 64)
        #self.cost3 = PointConvFlow(flow_nei, 256 + 64 + 256 + 64 + 3, [256, 256])
        self.cost3 = PointConvFlow(flow_nei, 195, [64, 64])
        self.flow3 = SceneFlowEstimatorPointConv(64, 64, flow_ch=0)
        self.level3_0 = Conv1d(64, 64)
        self.level3_1 = Conv1d(64, 128)
