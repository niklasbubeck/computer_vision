...
from loss import multiScaleChamferSmoothCurvature, get_cycle_loss_pytorch
scale = 1.0
...
class PointConvSceneFlowPWC8192selfglobalPointConv(pl.LightningModule):
    def __init__(self, model_module_params):
        ...
        self.cost1 = PointConvFlow(flow_nei, 128 +3, [32, 32])
        self.flow1 = SceneFlowEstimatorPointConv(32 + 64, 32)
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = total_loss_f
        logs = {"Loss": {"Train_overall":loss, "Train_chamfer":chamfer, "Train_curvature":curvature, "Train_smooth":smooth}, "Overall_Train":loss}
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # total_loss = total_loss_b + total_loss_f
        loss = total_loss_f
        logs = {"Loss": {"Val_overall":loss, "Val_chamfer":chamfer, "Val_curvature":curvature, "Val_smooth":smooth}, "Overall_Val":loss}
        self.log_dict(logs, prog_bar=False, logger=True, on_epoch=True, on_step=False, reduce_fx='mean')
        return loss
