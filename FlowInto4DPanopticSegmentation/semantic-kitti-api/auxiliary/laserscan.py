...
class LaserScan:
  ...
  def open_scan(self, filename):
    ...
    remissions = np.zeros((points.shape[0]))  # get remission
...
class SemLaserScan(LaserScan):
  ...
  def set_label(self, label):
    ...
    if label.shape[0] == self.points.shape[0]:
      ...
      raise ValueError("Scan %d and Label %d don't contain same number of points" % (self.points.shape[0], label.shape[0]))
