...
data_root = '../_output/flow_dataset/'
train_pipeline = [
    dict(type='LoadLidarFromFile', project=True, H=64, W=2048, fov_up=3.0, fov_down=-25.0, gt=False, max_points=300000,
...
data = dict(
    ...
    train=dict(
        ...
        sampler='configs/semantic_kitti_sampler.npy',
        split='train',
